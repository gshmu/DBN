...
public enum ProviderType {
 // first one is the default
  ...
  OCI(ProviderModel.COHERE_COMMAND,
  ...
  ProviderType(ProviderModel ... models) {
    this.models = new HashSet<>(List.of(models));
  }
