...
public class Messages {
    ...
    public static final String[] OPTIONS_YES_NO = options(nls("app.shared.button.Yes"), nls("app.shared.button.No"));
    public static final String[] OPTIONS_YES_CANCEL = options(nls("app.shared.button.Yes"), nls("app.shared.button.No"), nls("app.shared.button.Cancel"));
    ...
    public static void showErrorDialog(@Nullable Project project, @Nullable String title, String message, @Nullable Exception exception) {
        ...
        if (title == null) title = nls("msg.shared.title.Error");
